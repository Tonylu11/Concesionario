...
public class PrincipalGUI {
	...
	private File file;
	/**
	 * Se declara un archivo llamado selectedFile del tipo File.
	 */
	...
	private void initialize() {
		frame = new JFrame("Concesionario IES Gran Capitán - Sin Título");
					...
					if (opcion == 0) {
						...
						if (opcion == JFileChooser.APPROVE_OPTION) {
							...
							try {
								...
								System.out
										.println("El archivo no se ha encontrado.");
		...
		frame.setTitle("Sin T\u00EDtulo - Concesionario IES Gran Capit\u00E1n");
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				"Fssrc\\ConcesionarioGUI\\icono.gif"));
		frame.setBounds(100, 100, 450, 300);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);

		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon("src\\ConcesionarioGUI\\principal.png"));
		label.setBounds(41, 29, 168, 174);
